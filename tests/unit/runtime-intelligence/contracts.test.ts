...
describe("every record can be built from its declared fields", () => {
  const estimate: CapabilityEstimate = { score: 0.7, priorScore: 0.5, confidence: 0.4, samples: 3, priorWeight: 2, observedWeight: 3, observedWeightedValue: 2.1, updatedAt: AT };
