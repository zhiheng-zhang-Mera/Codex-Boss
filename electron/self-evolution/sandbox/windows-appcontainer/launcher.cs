...
internal static class SandboxLauncher
{
    ...
    private sealed class Request
    {
        ...
        public bool UseJob { get; private set; }
        ...
        {
            var request = new Request { TimeoutMs = 900000, ActiveProcessLimit = 1, MemoryLimitMb = 0, UseJob = true };
            foreach (string raw in lines)
            {
                ...
                switch (directive)
                {
                    ...
                    case "job": request.UseJob = value.Trim() != "0"; break;
                    case "env":
                    {
