...
import type { AppMode, AppSnapshot, BossTask, FinalizationPolicy, RemoteChannel, TaskMode, ViewBounds } from "../shared/contracts";
import type { ApiProtocol, ProviderId, RunTransport } from "../shared/provider-contracts";
    ...
    <section className="chat-half">
      ...
      <div className="composer-zone">
        ...
        {view === "research" ? <form className="research-launcher" onSubmit={startResearch}>
          ...
          <WorkspacePathField label="Workspace" ariaLabel="研究仓库" value={researchWorkspace} onChange={setResearchWorkspace} placeholder="本地仓库目录" disabled={sending} onError={(message) => setError(message)} />
